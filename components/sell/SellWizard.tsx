          ...
          <div className="mt-5 space-y-2.5">
            ...
            {step === 8 ? (
              <>
                ...
                <SummaryRow
                  label="Photos"
                  value={`${Object.values(photos).filter((p) => p.file).length} selected — attach in WhatsApp chat`}
                />
      ...
      <div className="card p-6 sm:p-8">
        <div className="rounded-3xl bg-gradient-to-br from-emerald-50 to-teal-50 p-6 ring-1 ring-emerald-100">
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-slate-500">
            ...
            full details are already typed — press <b className="text-slate-700">Send</b> and then
            attach your photos &amp; video directly in the same chat. Our pickup partner will call
