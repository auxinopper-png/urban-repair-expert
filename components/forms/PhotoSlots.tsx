...
export default function PhotoSlots({
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
      {slots.map((slot) => {
        const cur = value[slot.key] ?? { file: null, preview: null, uploading: false };
        return (
          <div key={slot.key}>
            <input
              ref={(el) => {
              ...
              capture={!slot.video ? "environment" : undefined}
              className="hidden"
              ...
              <div className="group relative aspect-square overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    onChange(slot.key, { file: null, preview: null, uploading: false });
                  }}
